// DOM KeyboardEvent.code → HID usage code (Wooting analog)
// Values from the USB HID Usage Tables for Keyboard/Keypad page
const DOM_TO_ANALOG: Record<string, number> = {
  // Letters
...
export function getAnalogKey(code: string): number {
